...
class AccountInvoice(models.Model):
    ...
    def _compute_amount(self):
        ...
        if self.currency_id and self.company_id and self.currency_id != self.company_id.currency_id:
            ...
            amount_to_pay_company_signed = currency_id.compute(self.amount_to_pay, self.company_id.currency_id)
    ...
    amount_total_company_signed = fields.Monetary(string='To pay in Company Currency', currency_field='company_currency_id',
        store=True, readonly=True, compute='_compute_amount',
    ...
    def _amount_by_group(self):
        for invoice in self:
            ...
            invoice.amount_by_group = [(
                ...
                len(res),
            ) for r in res if not r[0].post_total]
            invoice.amount_by_group_post_total = [(
                r[0].name, r[1]['amount'], r[1]['base'],
                fmt(r[1]['amount']), fmt(r[1]['base']),
                len(res),
            ) for r in res if r[0].post_total]
